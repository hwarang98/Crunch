...
namespace CGameplayTags
{
	...
	CRUNCH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_SpinAttack);
	CRUNCH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Spine_Cooldown);
	CRUNCH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Passive_Launch_Activate);
	
	CRUNCH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Death);
	CRUNCH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Stun);
}
